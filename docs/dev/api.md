...
| `zit.compare`             | Select two branches, symbolic tags, or check-ins and open their changed files in one multi-diff editor. |
| `zit.timelineCompare`     | Compare a timeline check-in with another selected revision.                                             |
